...
Version  : 4.0.0
Release  : 51
URL      : http://tarballs.openstack.org/os-brick/os-brick-4.0.0.tar.gz
Source0  : http://tarballs.openstack.org/os-brick/os-brick-4.0.0.tar.gz
Source1  : http://tarballs.openstack.org/os-brick/os-brick-4.0.0.tar.gz.asc
...
%prep
%setup -q -n os-brick-4.0.0
cd %{_builddir}/os-brick-4.0.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599158041
...
cp %{_builddir}/os-brick-4.0.0/LICENSE %{buildroot}/usr/share/package-licenses/os-brick/294b43b2cec9919063be1a3b49e8722648424779
