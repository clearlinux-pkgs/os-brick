...
Version  : 0.7.0
Release  : 7
URL      : http://tarballs.openstack.org/os-brick/os-brick-0.7.0.tar.gz
Source0  : http://tarballs.openstack.org/os-brick/os-brick-0.7.0.tar.gz
