...
Version  : 0.6.0
Release  : 6
URL      : http://tarballs.openstack.org/os-brick/os-brick-0.6.0.tar.gz
Source0  : http://tarballs.openstack.org/os-brick/os-brick-0.6.0.tar.gz
