...
%prep
%setup -q -n os-brick-4.0.1
cd %{_builddir}/os-brick-4.0.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599763399
...
cp %{_builddir}/os-brick-4.0.1/LICENSE %{buildroot}/usr/share/package-licenses/os-brick/294b43b2cec9919063be1a3b49e8722648424779
